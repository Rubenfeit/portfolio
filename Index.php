        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarColor01">
            <ul class="navbar-nav">
                ...
                <li class="nav-item  dropdown mx-3">
                    ...
                    <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                        <a class="nav-link  dropdown-item bg-dark" href="../projects/GestionEleves.html">Plate-forme Gestion d'eleves</a>
                        <a class="nav-link  dropdown-item bg-dark" href="../projects/JavaBanque.html">Project banque Java</a>
